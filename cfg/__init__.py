...
MODES = {"exp", "val", "predict", "export", "track", "benchmark"}
...
CLI_HELP_MSG = f"""
    ...
    1. Train a detection model for 10 epochs with an initial learning_rate of 0.01
        yolo exp data=coco8.yaml model=yolo11n.pt epochs=10 lr0=0.01
...
def get_save_dir(args, name=None):
    ...
    Examples:
        >>> from types import SimpleNamespace
        >>> args = SimpleNamespace(project="my_project", task="detect", mode="exp", exist_ok=True)
        >>> save_dir = get_save_dir(args)
        >>> print(save_dir)
        my_project/detect/exp
    """
...
def entrypoint(debug=""):
    ...
    Examples:
        ...
        >>> entrypoint("exp data=coco8.yaml model=yolo11n.pt epochs=10 lr0=0.01")
