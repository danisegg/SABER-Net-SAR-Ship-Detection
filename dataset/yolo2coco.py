...
parser.add_argument('--image_path', default='D:/Yolo/ultralytics-yolo11-20250624/ultralytics-yolo11-main/dataset/SSDD/images/test',type=str, help="path of images")
parser.add_argument('--label_path', default='D:/Yolo/ultralytics-yolo11-20250624/ultralytics-yolo11-main/dataset/SSDD/labels/test',type=str, help="path of labels .txt")
parser.add_argument('--save_path', default='zkz_SSDD_val.json', type=str, help="if not split the dataset, give a path to a json file")
