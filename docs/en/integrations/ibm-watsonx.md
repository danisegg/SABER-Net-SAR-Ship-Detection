---
comments: true
description: Dive into our detailed integration guide on using IBM Watson to exp a YOLO11 model. Uncover key features and step-by-step instructions on model training.
...
train: exp/images # exp images subdirectory
val: exp/images # validation images subdirectory
